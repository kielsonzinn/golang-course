...
// AtualizarPublicacao atualiza os dados de uma publicação
...
// BuscarPublicacaoPorUsuario traz todas as publicações de um usuario especifico
...
// CurtirPublicacao adiciona 1 curtida na publicação
